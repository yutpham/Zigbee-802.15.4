...
*
* Description : Delete a fixed-sized memory partition that managed by uC/OS-II.
*
* Arguments   : pmem     memory partition   
*
*               err      TBD
* Returns    : != (OS_MEM *)0  is the partition was created
*              == (OS_MEM *)0  if the partition was not created because of invalid arguments or, no
...
*/
#if OS_ZIGBEE_FRW == 1
void OSMemDelete (OS_MEM  *pmem, INT8U *err)
{
    OS_ENTER_CRITICAL();
    pmem->OSMemFreeList = OSMemFreeList;
    OSMemFreeList->OSMemFreeList = pmem;
    OS_EXIT_CRITICAL();
}
#endif
