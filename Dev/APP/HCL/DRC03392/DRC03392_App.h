#ifndef DRC03392_APP_H
#define DRC03392_APP_H

/*********************************************************************
    Filename:       DRC03392_App.h
...
/*
 * Task Initialization for the DRC03392 Application
 */
extern void DRC03392_Init( void* arg1, void* arg2 );

/*
 * Task Event Processor for the DRC03392 Application
 */
extern void DRC03392_ProcessEvent(  void* arg1, void* arg2  );

/*
 * Change the On Off state and generate a send event.
 */
extern void DRC03392_ChangeState( byte State );

/*
 * Toggle the On Off state and generate a send event.
 */
extern void DRC03392_ToggleState( void );

/*
 * Toggle the store/recall Preset state amd generate a send event.
 */
extern void DRC03392_TogglePreset( void );

/*
 * Set the level for the DRC03392 Application
 */
extern void DRC03392_DimBright_DRC( uint16 AttribId, byte Steps );

/*
 * Set AdjDRC for the DRC03392 Application
 */
extern void DRC03392_Adj_DRC( uint16 AdjDRC_AttribId, byte AdjDRC_Value);
